# MyProjects
This portfolio showcases a curated set of Power BI projects that reflect my ability to transform raw, often messy data into strategic insights. From healthcare and food delivery to financial KPIs and public datasets, each dashboard has been designed to address real-world business problems using clean design, performance-focused DAX logic, and domain-relevant analytics.
...
Excel (Data prep, KPI formulas)

Public datasets (Worldometer, industry benchmarks)

Design principles (color theory, layout, label clarity, dashboard hierarchy)

💼 Summary Statement for Recruiters / Hiring Managers
“This collection of Power BI dashboards demonstrates my ability to blend technical reporting skills with business acumen. Whether supporting financial operations, executive reporting, or corporate advisory workflows, I aim to create self-serve tools and data narratives that help decision-makers move faster and smarter.”
